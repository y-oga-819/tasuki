...
import { InteractionManager, type SelectedLineRange } from "@pierre/diffs";
import App from "./App";
...
// Patch: prevent InteractionManager.setSelection from throwing when
...
const origSetSelection = InteractionManager.prototype.setSelection;
InteractionManager.prototype.setSelection = function (range: SelectedLineRange | null) {
  try {
